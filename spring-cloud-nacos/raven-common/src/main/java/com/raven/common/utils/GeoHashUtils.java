...
/**
 * @description: GeoHash 算法工具类
 * @author: wangmingsheng
 * @time: 2020/6/9 15:28
 */
public class GeoHashUtils {
    ...
    /*public static void main(String[] args) {
        String encodeStr = GeoHashUtils.encode(40.7, 117.15);
        System.out.println(encodeStr);
        System.out.println(GeoHashUtils.decode(encodeStr)[0] + " "+ GeoHashUtils.decode(encodeStr)[1]);
    }*/
}