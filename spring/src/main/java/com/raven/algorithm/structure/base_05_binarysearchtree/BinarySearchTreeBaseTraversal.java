 ...
 * @author raven
 */
public class BinarySearchTreeBaseTraversal<E> implements BinaryTreeInfo {
     ...
     * 使用默认比较器
     */
    public BinarySearchTreeBaseTraversal() {
        this(null);
    }
     ...
     * @param comparator
     */
    public BinarySearchTreeBaseTraversal(Comparator<E> comparator) {
